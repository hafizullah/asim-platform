  ...
  Widget _buildMaterialLayout(BuildContext context, AppLocalizations localization) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // Language buttons in app bar actions
          Directionality(
            textDirection: TextDirection.ltr,
            child: Consumer<LanguageProvider>(
              builder: (context, languageProvider, child) {
                // For very small screens, show a dropdown, otherwise show buttons
                    ...
                    ? PopupMenuButton<String>(
                        ...
                        itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                          ...
                          PopupMenuItem<String>(
                            ...
                            child: Row(
                              children: [
                                if (languageProvider.locale.languageCode == 'fa')
                                  Icon(Icons.check, color: colorScheme.primary, size: 16),
                                if (languageProvider.locale.languageCode == 'fa')
                                  const SizedBox(width: 8),
                                Text(localization.dari),
                              ],
                            ),
                          ),
                          PopupMenuItem<String>(
                            ...
                            child: Row(
                              children: [
                                if (languageProvider.locale.languageCode == 'ps')
                                  Icon(Icons.check, color: colorScheme.primary, size: 16),
                                if (languageProvider.locale.languageCode == 'ps')
                                  const SizedBox(width: 8),
                                Text(localization.pashto),
                              ],
                            ),
                          ),
                        ],
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              PlanLocalizationUtils.getLocalizedSuitabilityGuide(plan, localization),
